...
// Pre-computed bcrypt hash for 'AgentMax2025!' (10 rounds) — avoids arm64 native binding issues
const AGENTMAX_PASSWORD_HASH = '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi';
...
async function seedAgentMax() {
    ...
    if (!organizer) {
        organizer = await prisma.user.create({
            data: {
                ...
                passwordHash: AGENTMAX_PASSWORD_HASH,
                firstName: 'AgentMaX',
                lastName: 'Team',
                role: 'ORGANIZER',
                status: 'ACTIVE',
        ...
        console.log('✅ Created AgentMax organizer user:', organizer.id);
    } else {
        console.log('ℹ️ AgentMax organizer already exists:', organizer.id);
    }
    ...
    console.log('✅ AgentMax hackathon created successfully!');
